...
public class BookAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ret = new BookViewHolder(itemView,this,mContext);
        return ret;
    }
    ...
    public static class BookViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public BookViewHolder(View itemView, BookAdapter adapter,Context context) {
            super(itemView);
        ...
        void bindView(final BookList item) {
            switch (item.getId()) {
                case 1:
                    ...
                    if (imageView != null) {
                        ...
                        if (cover != null) {
                            ...
                            Picasso.with(context)
                                    .load("http://tnfs.tngou.net/image" + cover)
